...
int main()
{
    ...
    uint8_t tweakey3[16];
    // Test vectors
    string tk1_str = "b372cdd48ca7d309d10f2fb2e6f5fe2a";
    string tk2_str = "365b015aac7bfd8f4b06b919864c3839";
    string tk3_str = "be050e4bade1547ef08330d6792e01af";
    string plain_str = "44405dd624507aa3e3d0092ace7f931f";
    string cipher_str = "4b25c67cf6f5d9dca8d718120fe3903c";
    convert_hexstr_to_statearray(tk1_str, tweakey1);
    convert_hexstr_to_statearray(tk2_str, tweakey2);
    convert_hexstr_to_statearray(tk3_str, tweakey3);
    ...
    //convert_hexstr_to_statearray(tk1_str_rv, tweakey1, true);
    //convert_hexstr_to_statearray(tk2_str_rv, tweakey2, true);
    //convert_hexstr_to_statearray(tk3_str_rv, tweakey3, true);
    //convert_hexstr_to_statearray(plain_rv, plaintext, true);
    for (uint8_t i = 0; i < 16; i++)
    {
        tk1[0][i] = tweakey1[i];
        tk2[0][i] = tweakey2[i];
